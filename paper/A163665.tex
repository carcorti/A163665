...
strings document the package validation environment; the public archive
for this package is release \texttt{v1.0.1}.
...
The public release package contains the production source, Makefile,
...
not included in the public package.  Their aggregate certified
content is represented by the run manifest and validation summary.
Release \texttt{v1.0.1} is archived with Zenodo DOI
\url{https://doi.org/10.5281/zenodo.21242104}.
...
positive-hit checkers are part of the public project package archived in
the GitHub repository and Zenodo record listed in the References.  The
snapshot material is
recorded in \texttt{docs/confirmation\_A163665.md}, not as a separate
standalone input-snapshot file.  No additional dataset is needed to
reproduce the finite claims stated in this note, apart from standard
toolchain components and the external programs used by the recorded
validation commands.
...
GitHub repository and Zenodo archive, release \texttt{v1.0.1}, 2026.
